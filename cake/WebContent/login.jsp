...
<body class="bg3">
    ...
    <header class="sj_header">
        <div class="row">
            <div class="col-xs-3"><span class="logo_sj"><a href="http://www.dingdangao.net.cn/Login/Index?link=http://www.dingdangao.net.cn/Login/Register#"><img src="<%=path %>/images/alogo7_03.png"></a></span></div>
            <div class="col-xs-9 text-right">
                <a class="yuyue_sj pull-right" href="http://www.dingdangao.net.cn/Login/Index?link=http://www.dingdangao.net.cn/Login/Register#">在线预约</a>
            </div>
                    ...
                    if (data.isOK) {
                        ...
                        if ($("#link").val() == "")
                            ...
                            if (window.location.search.indexOf('&') - 1) {
                                if (window.location.search.replace("?link=", "") == "http://localhost:5800/" || window.location.search.replace("?link=", "") == "http://120.76.153.103:8006/") {
