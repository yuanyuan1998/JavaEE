...
<div class="pull-left me_side">
    ...
    <div class="clearfix"></div>
        ...
        <ul class="mes_list">
            ...
            <li>
            	<a href="<%=path %>/personpaid.jsp" onclick="paid()">
            ...
            <c:forEach items="${cartlist }" var="c" >
        		<tr indexpid="11" id="li1-11" >
                    ...
                    <td valign="middle">
                    	...
                    	<span class="dd_num">
                    		<a onclick="jian('${c.product.id}','${c.size }','${c.count }')" href="javascript:">-</a>
                    		<input name="" type="text" value="${c.count }">
                    		<a onclick="add('${c.product.id}','${c.size }','${c.count }')" href="javascript:">+</a>
                    	</span>
                    </td>
