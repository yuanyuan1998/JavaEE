...
<html xmlns:wb="http://open.weibo.com/wb"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="<%=path %>/jd/hm.js.下载"></script><script src="<%=path %>/jd/hm.js(1).下载"></script><script src="<%=path %>/js/jquery-1.11.1.min.js.下载" type="text/javascript"></script>
...
<body class="bg3">
    <header class="sj_header">
        <div class="row">
            <div class="col-xs-3"><span class="logo_sj"><a href="http://www.dingdangao.net.cn/#"><img src="<%=path %>/images/alogo7_03.png"></a></span></div>
            <div class="col-xs-9 text-right">
                <a class="yuyue_sj pull-right" href="http://www.dingdangao.net.cn/#">在线预约</a>
            </div>
        </div>
    </header>
...
<form action="http://www.dingdangao.net.cn/Product/List1" id="list_form_type" method="post">                <input type="hidden" name="typeid" id="typeid">
                ...
                <div class=" pull-right menu_right">
                    ...
                    <%
                    	Integer countNum = (Integer)session.getAttribute("countNum");
                    	if(countNum == null){
                    		countNum = 0;	
                    	}
...
<div class="banner_box">
    <div class="page_a">
    <span class="page_cur">02</span>/<span class="page_all"> 04    </span>
    </div>
    <div class="bx-wrapper" style="max-width: 100%;">
    	<div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 585px;">
    		<ul style="width: 860%; position: relative; left: -2846px;">
	            <li style="float: left; list-style: none; position: relative; width: 1423px;"><a style="background-image:url(<%=path %>/images/fr_1709261110309492281.jpg)" href="<%=path %>/product/Product?id=7"></a></li>
            	<li style="float: left; list-style: none; position: relative; width: 1423px;"><a style="background-image:url(<%=path %>/images/fr_1709261108299084475.jpg)" href="<%=path %>/product/Product?id=8"></a></li>
            	<li style="float: left; list-style: none; position: relative; width: 1423px;"><a style="background-image:url(<%=path %>/images/fr_1709261109137968515.jpg)" href="<%=path %>/product/Product?id=9"></a></li>
          		<li style="float: left; list-style: none; position: relative; width: 1423px;"><a style="background-image:url(<%=path %>/images/fr_1709281730043992620.jpg)" href="<%=path %>/product/Product?id=10"></a></li>
       	 	</ul>
        </div>
...
<div class="container ad_series" id="data"> 
                <a class="ad_box" href="<%=path %>/product/Product?id=1">
                    <div class="cover"></div>
                    <img class="img_ad" src="<%=path %>/images/ps_1709261426373757779.jpg">
                    <div class="ad_text tui_tt">
                        <span>无限魅力</span>
                        <ins>￥128.00</ins>
                    </div>
                </a>
                <a class="ad_box" href="<%=path %>/product/Product?id=2">
                    <div class="cover"></div>
                    <img class="img_ad" src="<%=path %>/images/ps_1709261427489937623.jpg">
                    <div class="ad_text tui_tt">
                        <span>夏日抹茶</span>
                        <ins>￥138.00</ins>
                    </div>
                </a>
                <a class="ad_box" href="<%=path %>/product/Product?id=3">
                    <div class="cover"></div>
                    <img class="img_ad" src="<%=path %>/images/ps_1709261429019301567.jpg">
                    <div class="ad_text tui_tt">
                        <span>梦幻天使</span>
                        <ins>￥138.00</ins>
                    </div>
                </a>
                <a class="ad_box" href="<%=path %>/product/Product?id=10">
                    <div class="cover"></div>
                    <img class="img_ad" src="<%=path %>/images/ps_1710241356355830060.jpg">
                    <div class="ad_text tui_tt">
                        <span>我爱榴芒</span>
                        <ins>￥138.00</ins>
                    </div>
                </a>
                <a class="ad_box" href="<%=path %>/product/Product?id=4">
                    <div class="cover"></div>
                    <img class="img_ad" src="<%=path %>/images/ps_1709261437182368528.jpg">
                    <div class="ad_text tui_tt">
                        <span>榴莲相思</span>
                        <ins>￥138.00</ins>
                    </div>
