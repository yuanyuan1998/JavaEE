...
<head>
    ...
    <header class="sj_header">
        <div class="row">
            <div class="col-xs-3"><span class="logo_sj"><a href="http://www.dingdangao.net.cn/Product/Show/9#"><img src="<%=path %>/images/alogo7_03.png"></a></span></div>
            <div class="col-xs-9 text-right">
                <a class="yuyue_sj pull-right" href="http://www.dingdangao.net.cn/Product/Show/9#">在线预约</a>
            </div>
        </div>
    </header>
    <header class="web_header">
        <div class="container colxs">
			...
			<form action="http://www.dingdangao.net.cn/Product/List1" id="list_form_type" method="post">                
				<input type="hidden" name="typeid" id="typeid">
                <ul class="menu">
					<li class=""> <a href="<%=path %>/index.jsp">首页</a></li>
	                <li class=""> <a href="<%=path %>/product/allProduct">所有产品</a></li>
	                <li class=""> <a href="http://www.dingdangao.net.cn/Index/Index">热门产品</a></li>
	                <li class="">
	            ...
	            <div class=" pull-right menu_right">
	                ...
	                <a href="<%=path %>/cart.jsp"  id="countNum" onclick="checkCart()"class="co_g3 menu_nav">${countNum }件</a>
            ...
            success : function(date) {
            	if (date == 1) {
            		 var context = "您暂未登陆，是否登陆？";
	       		     ...
	       		     divCover.innerHTML = '<div class="pop_cont"><div class="p_box2_tips" style="height:65px;margin-top:35px;"><i class="pop_cg"></i>' + context + '</div></div><div class="pop_btn"><div style="margin-top: 10px;"><a class="back_home" href="javascript:" onclick="closeLoginPanel()"><i></i>否</a><a class="submit_order" href="<%=path%>/login.jsp"><i></i>是</a></div></div>';
