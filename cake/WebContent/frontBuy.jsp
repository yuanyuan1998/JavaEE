...
<body class="bg3">
    <header class="web_header">
        <div class="container colxs">
            <div class="pull-left logo"><img src="<%=path %>/images/alogo7_03.png" width="181" height="39"></div>
        	...
        	<c:forEach items="${cartlist }" var="c" >
        		<tr indexpid="11" id="li1-11">
                    ...
                    <td valign="middle">
                    	...
                    	<span class="dd_num">
                    		<input name="count" type="text" value="${c.count }">
                    	</span>
                    </td>
	    ...
	    $.ajax({
            ...
            success : function() {
            		 var context = "购买成功";
	       		     ...
	       		     divCover.innerHTML = '<div class="pop_cont"><div class="p_box2_tips" style="height:65px;margin-top:35px;"><i class="pop_cg"></i>' + context + '</div></div><div class="pop_btn"><div style="margin-top: 10px;"><a class="back_home" href="<%=path%>/frontIndex.jsp" onclick="closeLoginPanel()"><i></i>关闭</a></div></div>';
