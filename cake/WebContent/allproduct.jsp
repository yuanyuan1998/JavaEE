        ...
        <div class="row">
        	<c:forEach items="${lp }" var="lp">
        		<div class="lista col-lg-3">
                        <a class="list_pica" href="<%=path %>/product/Product?id=${lp.id }">
                            <img src="${lp.img1 }">
                        </a>
                        <div class="lista_text">
                            <div class="list_bt0">
                                <i class="icon_cu"><img src="<%=path %>/images/tag_new_38.png" width="39" height="16"></i>
                                <a class="bta" href="<%=path %>/product/Product?id=${lp.id }"><h2>${lp.name }</h2></a>
                                <span>￥ ${lp.price }</span>
                            </div>
                            <div class="list_bt1">
                                <span>￥ ${lp.price }</span>
                                <small class="">${lp.description }</small>
                                <ins><a class="btn_buya" href="<%=path %>/product/Product?id=${lp.id }">立即购买</a></ins>                         
                            </div>
                        </div>
                    </div>
        	</c:forEach>
